...
if "x%GRAILS_AGENT_CACHE_DIR%" == "x" set GRAILS_AGENT_CACHE_DIR=%SHORTHOME%/.grails/2.3.2/
...
set AGENT_STRING=-javaagent:"%GRAILS_HOME:\=/%/lib/org.springsource.springloaded/springloaded-core/jars/springloaded-core-1.1.4.jar" -noverify -Dspringloaded=\"%SPRINGLOADED_PARAMS%\"
...
set STARTER_CLASSPATH=%GRAILS_HOME%\lib\org.codehaus.groovy\groovy-all\jars\groovy-all-2.1.9.jar;%GRAILS_HOME%\dist\grails-bootstrap-2.3.2.jar
...
set JAVA_OPTS=%JAVA_OPTS% -Dgrails.version=2.3.2
